    ...
    public class SOFIA : Controller
    {
        ...
        public async Task<IActionResult> AddData([FromBody] DataFromNexus DFN)
        {
            try
            {
                ...
                var WBOR_EMPLOYMENT = new SqlParameter("@ND_WBOR_EMPLOYMENT", DFN.WBOR_EMPLOYMENT);
                var WBOR_ADDRESS1 = new SqlParameter("@ND_WBOR_ADDRESS1", DFN.WBOR_ADDRESS1);
                var WBOR_MONTHLY_INCOME = new SqlParameter("@ND_WBOR_MONTHLY_INCOME", DFN.WBOR_MONTHLY_INCOME);

                var APPL_INTERESTRATE_APPROVED = new SqlParameter("@ND_APPL_INTERESTRATE_APPROVED", DFN.APPL_INTERESTRATE_APPROVED);
                var APPL_TERMS_ACQUIRED = new SqlParameter("@ND_APPL_TERMS_ACQUIRED", DFN.APPL_TERMS_ACQUIRED);
                var APPL_INTERESTRATE_ACQUIRED = new SqlParameter("@ND_APPL_INTERESTRATE_ACQUIRED", DFN.APPL_INTERESTRATE_ACQUIRED);
                var APPL_PAYMENT_MODE = new SqlParameter("@ND_APPL_PAYMENT_MODE", DFN.APPL_PAYMENT_MODE);
                var APPL_GRACE_PERIOD = new SqlParameter("@ND_APPL_GRACE_PERIOD", DFN.APPL_GRACE_PERIOD);
...
"@WBOR_EMPLOYMENT = @ND_WBOR_EMPLOYMENT, " +
"@WBOR_ADDRESS1 = @ND_WBOR_ADDRESS1, " +
"@WBOR_MONTHLY_INCOME = @ND_WBOR_MONTHLY_INCOME, " +
"@APPL_INTERESTRATE_APPROVED = @ND_APPL_INTERESTRATE_APPROVED, " +
"@APPL_TERMS_ACQUIRED = @ND_APPL_TERMS_ACQUIRED, " +
"@APPL_INTERESTRATE_ACQUIRED = @ND_APPL_INTERESTRATE_ACQUIRED, " +
"@APPL_PAYMENT_MODE = @ND_APPL_PAYMENT_MODE, " +
"@APPL_GRACE_PERIOD = @ND_APPL_GRACE_PERIOD",
Company,
BRANCH_NAME,
APPL_CRM_CODE,
LAST_NAME,
...
WBOR_EMPLOYMENT,
                    ...
                    APPL_INTERESTRATE_APPROVED,
                    APPL_TERMS_ACQUIRED,
                    APPL_INTERESTRATE_ACQUIRED,
                    APPL_PAYMENT_MODE,
                    APPL_GRACE_PERIOD);
